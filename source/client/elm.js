	...
	return _circuithub$elm_bootstrap_html$Bootstrap_Html$container_(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_circuithub$elm_bootstrap_html$Bootstrap_Html$colXs_, 12, content)
					]))
			]));
};
...
var _gdotdesign$elm_ui$Main$br$ = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[]));
var _gdotdesign$elm_ui$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
...
var _gdotdesign$elm_ui$Main$decrementButton = A2(
	...
	_elm_lang$core$Native_Utils.update(
		...
		{
			label: _elm_lang$core$Maybe$Just('Decrement')
		}),
...
var _gdotdesign$elm_ui$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _gdotdesign$elm_ui$Main$init, view: _gdotdesign$elm_ui$Main$view, update: _gdotdesign$elm_ui$Main$update, subscriptions: _gdotdesign$elm_ui$Main$subscriptions})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _gdotdesign$elm_ui$Main$main === 'undefined' ? null : _gdotdesign$elm_ui$Main$main);
