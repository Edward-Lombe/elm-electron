	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_gdotdesign$elm_ui$Main$Decrement)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_gdotdesign$elm_ui$Main$Increment)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('+')
...
var _gdotdesign$elm_ui$Main$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _gdotdesign$elm_ui$Main$model, view: _gdotdesign$elm_ui$Main$view, update: _gdotdesign$elm_ui$Main$update})
};
